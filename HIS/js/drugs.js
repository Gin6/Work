...
$(document).ready(function (){
	$('.main_content').mouseover(function (){
		$('.main_right_bottom').css({"height": "5%", "border": "1px solid rgba(74, 74, 74, 0)",});
		$('.main_right_top').css({"height": "61%",});
		$('.drop_b').css({"z-index": "-1", "padding-top": "0%", "margin-top": "0%",});
	...
	$('.main_a').mouseout(function (){
		$('.main_right_bottom').css({"height": "70%", "border": "1px solid rgba(74, 74, 74, 0.79)",});
		$('.main_right_top').css({"height": "0%",});
		$('.drop_b').css({"z-index": "3", "padding-top": "3%", "margin-top": "1%",});
